import{ag as R,ah as v,ai as m}from"./GeoJSON-dVJCj0SI.js";import{W as S,e as d,n as b,u as $,U as r,P as C,A as _,g as x}from"./compileUtil-DE-8w3AG.js";import I from"./BaseTile-BU6ZW8RS.js";import"./index-DLQIbJqc.js";import"./utils-B7F_ho2D.js";import"./_commonjsHelpers-CE1G-McA.js";import"./I18N-DlIXJTel.js";import"./BFormRadioGroup.vue_vue_type_script_setup_true_lang-LQBMttYK-CW7mqt87.js";import"./useStateClass-BGbSLWFN-DVCkhww4.js";import"./ConditionalWrapper.vue_vue_type_script_lang-IX_NpHH--D04gVupl.js";import"./mat4-CeypvY8Z.js";import"./DataTile-B7a7Je00.js";import"./Tile-G7aX-9AV.js";import"./Tile-C6wKdysJ.js";import"./common-D17H8Wti.js";import"./TileRange-2Tc-Ry00.js";import"./LRUCache-D3qbVE6m.js";import"./tilecoord-CR7vLr2I.js";import"./TileProperty-BF4LcWSy.js";function T(s,e){const n=`
    attribute vec2 ${_.TEXTURE_COORD};
    ...
    void main() {
      v_textureCoord = ${_.TEXTURE_COORD};
      v_mapCoord = vec2(
  ...
  `,t={...b(),bandCount:e},i=[];if(s.color!==void 0){const o=d(t,s.color,v);i.push(`color = ${o};`)}if(s.contrast!==void 0){const o=d(t,s.contrast,m);i.push(`color.rgb = clamp((${o} + 1.0) * color.rgb - (${o} / 2.0), vec3(0.0, 0.0, 0.0), vec3(1.0, 1.0, 1.0));`)}if(s.exposure!==void 0){const o=d(t,s.exposure,m);i.push(`color.rgb = clamp((${o} + 1.0) * color.rgb, vec3(0.0, 0.0, 0.0), vec3(1.0, 1.0, 1.0));`)}if(s.saturation!==void 0){const o=d(t,s.saturation,m);i.push(`
    ...
    `)}if(s.gamma!==void 0){const o=d(t,s.gamma,m);i.push(`color.rgb = pow(color.rgb, vec3(1.0 / ${o}));`)}if(s.brightness!==void 0){const o=d(t,s.brightness,m);i.push(`color.rgb = clamp(color.rgb + ${o}, vec3(0.0, 0.0, 0.0), vec3(1.0, 1.0, 1.0));`)}const a={},c=Object.keys(t.variables).length;if(c>1&&!s.variables)throw new Error(`Missing variables in style (expected ${t.variables})`);for(let o=0;o<c;++o){const E=t.variables[Object.keys(t.variables)[o]];if(!(E.name in s.variables))throw new Error(`Missing '${E.name}' in style variables`);const p=$(E.name);a[p]=function(){let f=s.variables[E.name];return typeof f=="string"&&(f=x(f)),f!==void 0?f:-9999999}}const u=Object.keys(a).map(function(o){return`uniform float ${o};`}),h=Math.ceil(e/4);u.push(`uniform sampler2D ${r.TILE_TEXTURE_ARRAY}[${h}];`),t.paletteTextures&&u.push(`uniform sampler2D ${C}[${t.paletteTextures.length}];`);const l=Object.keys(t.functions).map(function(o){return t.functions[o]}),g=`
